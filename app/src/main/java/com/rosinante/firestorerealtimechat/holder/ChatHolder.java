...
public class ChatHolder extends RecyclerView.ViewHolder {
    ...
    public ChatHolder(View itemView) {
        super(itemView);
        mNameField = itemView.findViewById(R.id.text_user);
        mTextField = itemView.findViewById(R.id.text_message);
        mLeftArrow = itemView.findViewById(R.id.left_arrow);
        mRightArrow = itemView.findViewById(R.id.right_arrow);
        mMessageContainer = itemView.findViewById(R.id.chat_message_container);
        mMessage = itemView.findViewById(R.id.message_buble);
